...
export interface LimitedTokenInterface extends ethers.utils.Interface {
  functions: {
...
export interface LimitedToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LimitedTokenInterface;
