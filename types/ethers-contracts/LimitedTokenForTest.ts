...
export interface LimitedTokenForTestInterface extends ethers.utils.Interface {
  functions: {
...
export interface LimitedTokenForTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LimitedTokenForTestInterface;
  ...
  callStatic: {
    ...
    bypassedLock(overrides?: CallOverrides): Promise<void>;
  };
